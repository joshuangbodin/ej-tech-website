...
const Footer = (props: Props) => {
  return (
    <div className="w-full h-[300px] mt-40 bg-purple-950 p-6 flex  flex-col justify-center  text-white">
      <h3>EJ-TECH</h3>
      ...
      <div className="  w-full flex justify-center items-center h-12 text-gray-200">
